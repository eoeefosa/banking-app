...
class Repository {
  ...
  static Color cardColor3B(BuildContext context) {
    final vm = context.watch<ViewModel>();
    return vm.isDark == true ? Styles.blueColor : Styles.cyanpink;
  }

  static Color headerColor2A(BuildContext context) {
    final vm = context.watch<ViewModel>();
    return vm.isDark == true ? Styles.whiteColor : Styles.whiteColor;
  }

  static Color purchaseDataheadercolor(BuildContext context) {
    final vm = context.watch<ViewModel>();
    return vm.isDark == true
        ? Styles.whiteColor
        : Styles.purchasedataheadercolor;
  }
  ...
  static Color cardColor2B(BuildContext context) {
    final vm = context.watch<ViewModel>();
    return vm.isDark == true ? Styles.greenColor : Styles.bluecardColor2;
  }

  static Color cardColor2A(BuildContext context) {
    final vm = context.watch<ViewModel>();
    return vm.isDark == true ? Styles.accentColor : Styles.blueCardcolor;
  }
